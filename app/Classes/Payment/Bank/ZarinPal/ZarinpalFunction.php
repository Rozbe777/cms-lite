...
class ZarinpalFunction
{
    ...
    private function zarinpal_node()
    {
        ...
        {
            $ir_ch = curl_init("https://sandbox.zarinpal.com/pg/services/WebGate/wsdl");
            ...
            if (function_exists('fsockopen'))
            {
                ...
                $ir_ping 	= $this->zarinpal_ping("sandbox.zarinpal.com", 80, 1);

                $de_domain 	= "https://de.zarinpal.com/pg/services/WebGate/wsdl";
                $ir_domain 	= "https://sandbox.zarinpal.com/pg/services/WebGate/wsdl";
                ...
                $webservice = "https://sandbox.zarinpal.com/pg/services/WebGate/wsd";
