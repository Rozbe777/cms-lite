...
class UserController extends Controller
{
    ...
    public function store(CreateUserRequest $request)
    {
        ...
        return redirect(route("admin.user.index"))->with("msg", "کاربر جدید ایجاد شد.");
    ...
    {
        User::forceDelete($id);
        return redirect(route("admin.user.index"))->with("msg", "کاربر مدنظر حذف شد.");
    ...
    public function edit(EditUserRequest $request)
    {
        ...
        return redirect(route("admin.user.index"))->with("msg", "اطلاعات کاربر ویرایش شد.");
    }
