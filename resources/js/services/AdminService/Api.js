...
export const Request = {
    ...
    DeleteCoupon : (data) =>  request.delete("/coupons/multi/destroy" , {params : data}),
    UpdateDataCategory :  (data , id) =>  request.post("/categories/update" , data),
    UpdateDataProduct :  (data , id) =>  request.post("/products/update" , data),
    UpdateDataPage :  (data) =>  request.post("/pages/update" , data),
