        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 posts-list">
                        ...
                        <div class="navigation-area">
                            <div class="row">
                                <div
                                    ...
                                    <div class="thumb">
                                        <a href="#">
                                            <img class="img-fluid" src="{{ asset('portal/img/post/preview.png') }}"
                                                 alt="">
                                        </a>
                                    </div>
                                    <div class="arrow">
                                ...
                                <div
                                    ...
                                    <div class="thumb">
                                        <a href="#">
                                            <img class="img-fluid" src="{{ asset('portal/img/post/next.png') }}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    {{--                            <img src="{{ asset('portal/img/blog/author.png') }}" alt="">--}}
                    ...
                    {{--                                    <div class="thumb">--}}
                    {{--                                        <img src="{{ asset('portal/img/comment/comment_1.png') }}" alt="">--}}
                    {{--                                    </div>--}}
                    {{--                                    <div class="desc">--}}
                    {{--                                        <p class="comment">--}}
                    ...
                    {{--                                <div class="user justify-content-between d-flex">--}}
                    {{--                                    <div class="thumb">--}}
                    {{--                                        <img src="{{ asset('portal/img/comment/comment_2.png') }}" alt="">--}}
                    {{--                                    </div>--}}
                    {{--                                    <div class="desc">--}}
                    {{--                                        <p class="comment">--}}
                    {{--                                            Multiply sea night grass fourth day sea lesser rule open subdue female fill which them--}}
                    ...
                    {{--                                <div class="user justify-content-between d-flex">--}}
                    {{--                                    <div class="thumb">--}}
                    {{--                                        <img src="{{ asset('portal/img/comment/comment_3.png') }}" alt="">--}}
                    {{--                                    </div>--}}
                    {{--                                    <div class="desc">--}}
                    {{--                                        <p class="comment">--}}
                    {{--                                            Multiply sea night grass fourth day sea lesser rule open subdue female fill which them--}}
                    ...
                    <div class="col-lg-4">
                        <div class="blog_right_sidebar">
                            ...
                            <aside class="single_sidebar_widget popular_post_widget">
                                <h3 class="widget_title">محتواهای جدید</h3>
