<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow expanded" data-scroll-to-active="true" style="touch-action: none; user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
    ...
    <div class="main-menu-content ps ps--active-y">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="">
            <li class="nav-item has-sub sidebar-group-active"><a href="index.html"><i class="bx bx-home-alt"></i><span class="menu-title" data-i18n="Dashboard">داشبورد</span><span class="badge badge-light-danger badge-pill badge-round float-right mr-2">2</span></a>
                <ul class="menu-content" style="">
                    <li class=""><a href="dashboard-ecommerce.html"><i class="bx bx-left-arrow-alt"></i><span class="menu-item" data-i18n="eCommerce">تجارت الکترونیک</span></a>
                    </li>
            ...
            <li class="nav-item has-sub"><a href="#"><i class="bx bx-file"></i><span class="menu-title" data-i18n="Invoice">صورتحساب</span></a>
                <ul class="menu-content" style="">
                    <li class=""><a href="app-invoice-list.html"><i class="bx bx-left-arrow-alt"></i><span class="menu-item" data-i18n="Invoice List">لیست صورتحساب ها</span></a>
                    </li>
                    <li class=""><a href="app-invoice.html"><i class="bx bx-left-arrow-alt"></i><span class="menu-item" data-i18n="Invoice">صورتحساب</span></a>
                    </li>
                    <li class=""><a href="app-invoice-edit.html"><i class="bx bx-left-arrow-alt"></i><span class="menu-item" data-i18n="Invoice Edit">ویرایش صورتحساب</span></a>
                    </li>
                    <li class=""><a href="app-invoice-add.html"><i class="bx bx-left-arrow-alt"></i><span class="menu-item" data-i18n="Invoice Add">افزودن صورتحساب</span></a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item has-sub"><a href="#"><i class="bx bx-repeat"></i><span class="menu-title" data-i18n="Content">محتوا</span></a>
            ...
            <li class="nav-item has-sub"><a href="#"><i class="bx bx-bulb"></i><span class="menu-title" data-i18n="Icons">آیکن&zwnj;ها</span></a>
                <ul class="menu-content">
            ...
            <li class="nav-item has-sub"><a href="#"><i class="bx bx-square-rounded"></i><span class="menu-title" data-i18n="Card">کارت</span></a>
                <ul class="menu-content">
            ...
            <li class=" nav-item"><a href="widgets.html"><i class="bx bx-grid"></i><span class="menu-title" data-i18n="Card Widgets">ویجت&zwnj;ها</span><span class="badge badge-light-primary badge-pill badge-round float-right">جدید</span></a>
            </li>
            <li class="nav-item has-sub"><a href="#"><i class="bx bx-briefcase-alt-2"></i><span class="menu-title" data-i18n="Components">اجزاء</span></a>
                <ul class="menu-content">
                    <li><a href="component-alerts.html"><i class="bx bx-left-arrow-alt"></i><span class="menu-item" data-i18n="Alerts">اعلان&zwnj;ها</span></a>
                    </li>
                    ...
                    <li><a href="component-pagination.html"><i class="bx bx-left-arrow-alt"></i><span class="menu-item" data-i18n="Pagination">صفحه&zwnj;بندی</span></a>
                    </li>
            ...
            <li class="nav-item has-sub"><a href="#"><i class="bx bx-briefcase"></i><span class="menu-title" data-i18n="Extra Components">اجزای بیشتر</span></a>
                <ul class="menu-content">
            ...
            <li class="nav-item has-sub"><a href="#"><i class="bx bx-check"></i><span class="menu-title" data-i18n="Form Elements">عناصر فرم</span></a>
                <ul class="menu-content">
            ...
            <li class="nav-item has-sub"><a href="#"><i class="bx bx-user-plus"></i><span class="menu-title" data-i18n="User">کاربران</span></a>
                <ul class="menu-content">
                    <li><a href="page-users-list.html"><i class="bx bx-left-arrow-alt"></i><span class="menu-item" data-i18n="List">لیست</span></a>
                    </li>
            ...
            <li class="nav-item has-sub"><a href="#"><i class="bx bx-building"></i><span class="menu-title" data-i18n="Starter kit">طرح های شروع</span></a>
                <ul class="menu-content">
            ...
            <li class="nav-item has-sub"><a href="#"><i class="bx bx-lock-open-alt"></i><span class="menu-title" data-i18n="Authentication">احراز هویت</span></a>
                <ul class="menu-content">
            ...
            <li class="nav-item has-sub"><a href="#"><i class="bx bx-share-alt"></i><span class="menu-title" data-i18n="Miscellaneous">متفرقه</span></a>
                <ul class="menu-content">
                    ...
                    <li class="has-sub"><a href="#"><i class="bx bx-left-arrow-alt"></i><span class="menu-item" data-i18n="Error">خطا</span></a>
                        <ul class="menu-content">
            ...
            <li class="nav-item has-sub"><a href="#"><i class="bx bx-pie-chart-alt"></i><span class="menu-title" data-i18n="Charts">نمودار ها</span><span class="badge badge-pill badge-round badge-light-success float-right mr-2">3</span></a>
                <ul class="menu-content">
            ...
            <li class="nav-item has-sub"><a href="#"><i class="bx bx-menu"></i><span class="menu-title" data-i18n="Menu Levels">سطح های فهرست</span></a>
                <ul class="menu-content">
                    <li><a href="#"><i class="bx bx-left-arrow-alt"></i><span class="menu-item" data-i18n="Second Level">سطح دوم</span></a>
                    </li>
                    <li class="has-sub"><a href="#"><i class="bx bx-left-arrow-alt"></i><span class="menu-item" data-i18n="Second Level">سطح دوم</span></a>
                        <ul class="menu-content">
        ...
        <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 261px; left: 253px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 28px;"></div></div></div>
</div>
