...
{{--                                                </div>--}}
                                                <form action="{{route('auth.login')}}" method="POST">
                                                    ...
                                                    <div class="form-group mb-50">
                                                        ...
                                                        <input type="text" class="form-control text-left" id="username" value="{{old('username')}}" name="username" placeholder="نام کاربری" dir="ltr">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="text-bold-700" for="exampleInputPassword1">رمز عبور</label>
                                                        <input type="password" class="form-control text-left" name="password" id="exampleInputPassword1" placeholder="رمز عبور" dir="ltr">
                                                    </div>
                                                ...
                                                <hr>
                                                <div class="text-center"><small class="mr-25">حسابی ندارید؟</small><a href="{{route('auth.register')}}"><small>ثبت نام</small></a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 d-md-block d-none text-center align-self-center p-3">
                                    <div class="card-content">
                                        <img class="img-fluid" src="{{adminTheme("images/pages/login.png")}}" alt="branding logo">
                                    </div>
                                </div>
                            </div>
                        </div>
