...
<head>
    ...
    <title>winter</title>
    <link rel="icon" href="{{ asset('portal/img/favicon.png') }}">
    <!-- Bootstrap CSS -->
    ...
    <!-- font awesome CSS -->
    <link rel="stylesheet" href="{{ asset('portal/css/all.css') }}">
    <!-- flaticon CSS -->
    ...
    <!-- swiper CSS -->
    <link rel="stylesheet" href="{{ asset('portal/css/slick.css') }}">
    <!-- style CSS -->
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-11">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="index.html"> <img src="{{asset('portal/img/logo.png')}}" alt="logo"> </a>
...
<!-- jquery plugins here-->
<script src="{{ asset('portal/js/jquery-1.12.1.min.js') }}"></script>
<!-- popper js -->
...
<!-- swiper js -->
<script src="{{ asset('portal/js/swiper.min.js') }}"></script>
<!-- swiper js -->
<script src="{{ asset('portal/js/mixitup.min.js') }}"></script>
<!-- particles js -->
...
<script src="{{ asset('portal/js/jquery.counterup.min.js') }}"></script>
<script src="{{ asset('portal/js/waypoints.min.js') }}"></script>
<script src="{{ asset('portal/js/contact.js') }}"></script>
<script src="{{ asset('portal/js/jquery.ajaxchimp.min.js') }}"></script>
<script src="{{ asset('portal/js/jquery.form.js') }}"></script>
