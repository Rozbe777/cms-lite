<head>
    ...
    <link rel="stylesheet" href="{{themeAsset('css/magnific-popup.min.css')}}">
    <link rel="stylesheet" href="{{themeAsset('css/odometer.min.css')}}">
    <link rel="stylesheet" href="{{themeAsset('css/showMoreItems-theme.min.css')}}">
    <link rel="stylesheet" href="{{themeAsset('css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{themeAsset('css/owl.theme.default.min.css')}}">
    <link rel="stylesheet" href="{{themeAsset('css/remixicon.css')}}">
