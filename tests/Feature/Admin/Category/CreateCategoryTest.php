...
{
    public function test_load_create_category_page_with_status_code_200_as_admin()
    {
    ...
    public function test_not_load_create_category_page_with_status_code_403_as_user()
    {
    ...
    public function test_create_category_as_admin_success()
    {
    ...
    public function test_create_category_required_validation()
    {
        $category = [
//            'name' => 'sdfefg',//required|string|max:255|unique:categories,name
//            'slug' => 'Smith',//required|string|max:255|unique:categories,slug
